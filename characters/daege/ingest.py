...
# -*- coding: utf-8 -*-
"""
~/Downloads/daege_<pose>.png (Gemini 다운로드) → poses/<pose>_raw.png → 배경제거 → 게임반영

사용법:
  1) Gemini(대게 대화 이어서)에서 포즈를 뽑아 daege_<pose>.png 로 다운로드
...
def main():
    ...
    brought = []
    for pose in todo:
        src = os.path.join(DL, f"daege_{pose}.png")
    ...
    if not brought:
        print("들여온 포즈 없음. ~/Downloads/daege_<pose>.png 를 확인하세요.")
